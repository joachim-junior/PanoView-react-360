...
export default class TourismVR extends React.Component {
  render() {
    return (
      <View>
        <Image source={asset('welcome.jpg')} style={{width: 500, height: 300}} />
        <View style={styles.attractionBox}>
          <VrButton onClick={() => surfaceModule.start()}>
            <Text style={styles.attractionText}>
              Welcome to PanoView Beautiful Gdansk, Poland! Click Here! to View our Amazing Site!
            </Text>
          </VrButton>
        </View>
      </View>
...
AudioModule.playEnvironmental({
  source: asset('sounds/background.mp3'),
